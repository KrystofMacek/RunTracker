...
class MainViewModel @ViewModelInject constructor(
    ...
    private val runsSortedByTimeLength = repository.getAllRunsSortedByTimeLength()
    ...
    /**
     * Add Mediator Live Data sources
     * */
    init {
        ...
        runs.addSource(runsSortedByTimeLength) { result ->
    ...
    /**
     * Set runs value data based on the SortType selected
     * */
    fun sortRuns(sortType: SortType) = when(sortType) {
        SortType.DATE -> runsSortedByDate.value?.let { runs.value = it }
        SortType.RUNNING_TIME -> runsSortedByTimeLength.value?.let { runs.value = it }
